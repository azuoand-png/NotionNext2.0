...
export default function NavBar(props) {
  return (
    /* 修改点：
      1. md:-mr-35：让侧边栏向右平移更多，极度靠近边缘。
      2. md:w-60：强制设定宽度为 15rem，这样它会从左侧“推开”文章区，形成 15rem 的间距。
    */
    <div className='flex flex-col justify-between md:mt-20 md:h-[70vh] md:-mr-35 md:w-60'>
