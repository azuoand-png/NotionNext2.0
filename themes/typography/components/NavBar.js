...
export default function NavBar(props) {
  return (
    /* md:-mr-[140px]: 强制向右平移 140px，使用方括号可以避开 Tailwind 预设数值限制
      md:pl-[15rem]: 强制设定左内边距为 15rem
    */
    <div className='flex flex-col justify-between md:mt-20 md:h-[70vh] md:-mr-[140px] md:pl-[15rem]'>
